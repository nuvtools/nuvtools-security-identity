                                           ...
                                           where TKey : IEquatable<TKey>
{
    ...
    public async Task<IResult<TKey>> CreateAndSendConfirmationEmailAsync(TUser value, string origin, string message = null, string subject = null, params string[] roles)
    {
        ...
        return await SendConfirmationEmailAsync(value, origin, message, subject);
    }

    public async Task<IResult<TKey>> SendConfirmationEmailAsync(TUser value, string origin, string message = null, string subject = null)
    {
    ...
    public async Task<IResult> RequestChangeEmailAsync(string email, string newEmail, string origin, string message = null, string subject = null, string route = "security/change-email")
    {
    ...
    public async Task<IResult> RequestResetPasswordAsync(string email, string origin, string message = null, string subject = null, string route = "security/reset-password")
    {
        var user = await _userManager.FindByEmailAsync(email);
        if (user == null || !await _userManager.IsEmailConfirmedAsync(user))
        {
